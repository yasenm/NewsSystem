    ...
    public class WeatherController : Controller
    {
        ...
        public ActionResult City()
        {
            try
            {
                ...
                var result = webClient.DownloadString(new Uri($"http://api.openweathermap.org/data/2.5/group?id=727011,728193,726050,732770,728203,726546,725712,725905,733191&appid={weatherAPIKey}&lang=bg&units=metric"));
